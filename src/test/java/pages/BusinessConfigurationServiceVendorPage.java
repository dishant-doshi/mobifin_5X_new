...
public class BusinessConfigurationServiceVendorPage extends SetupInit {
	CommonPage common;
	...
	By txtServiceVendorName = By.id(Utility.readJSFile("INPUT_SERVICES_ADD_NAME", CommonConstants.ELEMENT_FILE));
	...
	By btnAddKYCLevel = By.xpath("//*[contains(@class,'current')]//*[normalize-space(text())='"
			+ ScriptConstants.SERVICEVENDOR_ADDFIELD + "']//parent::button");
	...
	String operatingEntity = "//*[normalize-space(text()) = 'Operating Entity']//ancestor:: div[@class='ant-row ant-form-item']//*[normalize-space(text())='%s']";
	...
	String retryCount = "//*[normalize-space(text()) = '"
			...
			+ "']//ancestor:: div[@class='ant-row ant-form-item']//*[normalize-space(text())='%s']";
	String version = "//*[normalize-space(text()) = 'Version']//ancestor:: div[@class='ant-row ant-form-item']//*[normalize-space(text())='%s']";
	...
	String library = "//*[normalize-space(text()) = 'Library']//ancestor:: div[@class='ant-row ant-form-item']//*[normalize-space(text())='%s']";
	String channel = "//*[normalize-space(text()) = 'Channel']//ancestor:: div[@class='ant-row ant-form-item']//*[normalize-space(text())='%s']";
	String soapUrl = "//*[normalize-space(text()) = 'Soap Url']//ancestor:: div[@class='ant-row ant-form-item']//*[normalize-space(text())='%s']";
	String soapVersion = "//*[normalize-space(text()) = 'Soap Version']//ancestor:: div[@class='ant-row ant-form-item']//*[normalize-space(text())='%s']";
	String apiTemplate = "//*[normalize-space(text()) = 'API Template']//ancestor:: div[@class='ant-row ant-form-item']//*[normalize-space(text())='%s']";

	public BusinessConfigurationServiceVendorPage(WebDriver driver) {
		this.driver = driver;
		common = new CommonPage(this.driver);
	}

	public void sendTextInName(String name) {
		sendKeys(txtServiceVendorName, name, 0);
	}
	...
	public void sendTextInAPITemplate(String apiTemplate) {
		sendKeys(txtApiTemplate, apiTemplate, 0);
	}
	...
	public void selectVersion(String version) {
		selectFromDropDown(drpVersion, By.xpath(String.format(dropDownValue, version)), 0);
	}

	public void selectLibrary(String library) {
		selectFromDropDown(drpLibrary, By.xpath(String.format(dropDownValue, library)), 0);
	}

	public void selectChannel(String Channel) {
		selectFromDropDown(drpChannel, By.xpath(String.format(dropDownValue, Channel)), 0);
	}

	public void sendTextInHost(String host) {
		sendKeys(txtHost, host, 0);
	}

	public void sendTextInPort(String port) {
		sendKeys(txtPort, port, 0);
	}

	public void sendTextInSoapUrl(String soapUrl) {
		sendKeys(txtSoapUrl, soapUrl, 0);
	}

	public void selectSoapVersion(String soapVersion) {
		selectFromDropDown(drpSoapVersion, By.xpath(String.format(dropDownValue, soapVersion)), 0);
	}
	...
	public void verifyAddedServiceVendor(Map<Object, Object> map, List<Object> mapKeys) {
		filterSearch(map.get(mapKeys.get(1)).toString(), map.get(mapKeys.get(38)).toString(), true);
		...
		verifyVisible(By.xpath(String.format(operatingEntity, map.get(mapKeys.get(4)).toString())), 0);
		String[] navigation = map.get(mapKeys.get(39)).toString().split(",");
		clickOnElement(By.xpath(String.format(navigate, navigation[0])));
		...
		if (map.get(mapKeys.get(9)).toString().toLowerCase().equals("iso")) {
			verifyVisible(By.xpath(String.format(version, map.get(mapKeys.get(30)).toString())), 0);
			...
			verifyVisible(By.xpath(String.format(library, map.get(mapKeys.get(34)).toString())), 0);
			verifyVisible(By.xpath(String.format(channel, map.get(mapKeys.get(35)).toString())), 0);
		}
		if (map.get(mapKeys.get(9)).toString().toLowerCase().equals("soap")) {
			verifyVisible(By.xpath(String.format(soapUrl, map.get(mapKeys.get(36)).toString())), 0);
			verifyVisible(By.xpath(String.format(soapVersion, map.get(mapKeys.get(37)).toString())), 0);
		}
	...
	public boolean editServiceVendor(Map<Object, Object> map, List<Object> mapKeys) {
		filterSearch(map.get(mapKeys.get(1)).toString(), map.get(mapKeys.get(38)).toString(), true);
	...
	public void verifyEditedServiceVendor(Map<Object, Object> map, List<Object> mapKeys) {
